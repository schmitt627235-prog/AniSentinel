...
- Conan: Beide Crunchyroll-Kataloge und der bestätigte Apple-TV-Katalog bleiben intern getrennt, erscheinen aber in der normalen Provider- und Staffelnavigation ohne technische Katalog-IDs.
- Der öffentliche Apple-TV-Katalog wird staffelweise vollständig über Apples eigene Metadaten-Paginierung ermittelt. Fehlende Apple-Folgen werden nicht aus anderen Quellen ergänzt; eine teilweise Antwort ersetzt keinen vollständigeren Bestand.
- Die laufende Conan-Staffel von Crunchyroll erscheint als „32 (Aktuell)“; ursprüngliche Provideridentität und Links bleiben erhalten.
- Apple TV und AKIBA PASS sind nun in der Anbieterverwaltung separat ein- und ausschaltbar.
- Debug-APK und JVM-Tests lokal geprüft; Updateinstallation auf dem Android-Gerät ohne Löschen von App-Daten getestet.
